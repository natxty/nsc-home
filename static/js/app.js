$(document).ready(function() {
	...
	$(function(){
		...
		jQuery('#maximage').maximage({
			cycleOptions: {
				...
				speed: 1000, 
				prev: '#slider_thumb_left',
				next: '#slider_thumb_right',
				pause: 1,
				before: function() {
					$('.slider_thumb').fadeOut('slow')
				},
				after: function() {
					$('.slider_thumb').fadeIn('fast')
				}
			},
			fillElement: '#wrapper'
		});
	...
	*/
	...
	/* add the click instead of mouseover */
	$('#mag-footer-toggle-button').click( function() {
		mystickybar.toggle()
	})
